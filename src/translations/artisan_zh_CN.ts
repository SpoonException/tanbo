...
在绘图仪中使用数学公式还允许使用符号变量 P 和 F（请参阅信号、符号分配和绘图仪）。</translation>
    ...
    <message>
        <source>Open the roast in TotalLINK</source>
        <translation type="vanished">在 TotalLINK 中打开烘焙</translation>
    </message>
    <message>
        <source>Requires an TotalLINK account</source>
        <translation type="vanished">需要一个 TotalLINK 帐户</translation>
    </message>
    <message>
        <source>Sync the roast with TotalLINK</source>
        <translation type="vanished">将烘焙与 TotalLINK 同步</translation>
    </message>
    <message>
        <source>You might want to re-roast a profile, but extended/restricted to a total length of 10:00.

Load the profile and start the Transposer under Tools. Enter our target roast time of "10:00" minutes into the target DROP field under Time and select "linear" as mapping. Check the resulting times of the main events in the time tables last row, press "Apply" to view the transposed profile in the graph. If you are happy with the result, press "OK" and save the newly generated transposed profile such that you can use it as a template for future roasts.</source>
        <translation type="vanished">您可能想要重新烘焙配置文件，但扩展/限制为 10:00 的总长度。
...
加载配置文件并在工具下启动转置器。在 Time 下的 target DROP 字段中输入我们的目标烘焙时间“10:00”分钟，然后选择“linear”作为映射。检查时间表最后一行中主要事件的结果时间，按“应用”以查看图表中的转置配置文件。如果您对结果满意，请按“确定”并保存新生成的转置配置文件，以便您可以将其用作未来烘焙的模板。</translation>
    ...
    <message>
        <source>Insert Data address : value, ex. 4701:1000 and sv is 100.
Always multiply with 10 if value Unit: 0.1 / ex. 4719:0 stops heating</source>
        <translation type="vanished">插入数据地址：值，例如。 4701:1000 并且 sv 是 100。
...
Before CHARGE shows negative
Displays &amp;#39;*&amp;#39; when no CHARGE event exists</source>
        <translation type="vanished">CHARGE 之前或之后的秒数
在CHARGE显示负数之前
...
Before CHARGE shows negative
Displays &amp;#39;*&amp;#39; when no CHARGE event exists</source>
        <translation type="vanished">CHARGE 之前或之后的时间，以 min:sec 为单位
在CHARGE显示负数之前
显示 &amp;#39;*&amp;#39;当不存在 CHARGE 事件时</translation>
    </message>
    <message>
...
Negative value before FCs
Displays &amp;#39;*&amp;#39; when no FCs event exists</source>
        <translation type="vanished">FC 之前或之后的秒数
最好在双引号内使用（见下面的注释）
FC 之前的负值
...
Negative value before FCs
Displays &amp;#39;*&amp;#39; when no FCs event exists</source>
        <translation type="vanished">FC 后的时间（以 min:sec 为单位）
最好在双引号内使用（见下面的注释）
FC 前的负值
显示 &amp;#39;*&amp;#39;当不存在 FCs 事件时</translation>
    </message>
...
Positive value only
Displays &amp;#39;*&amp;#39; after FCs or when no FCs event exists</source>
        <translation type="vanished">FC 之前的秒数
...
Positive value only
Displays &amp;#39;*&amp;#39; after FCs or when no FCs event exists</source>
        <translation type="vanished">FC 之前的时间（以 min:sec 为单位）
最好在单引号或反引号内使用（见下面的注释）
仅正值
显示 &amp;#39;*&amp;#39;在 FC 之后或不存在 FC 事件时</translation>
    </message>
    <message>
        <source>Development time ratio (percent). Note: DTR=0 before FCs
100*(t{Event}-t{FCs})/(t{FCs}-t{CHARGE})</source>
        <translation type="vanished">开发时间比率（百分比）。注意：FC 前 DTR=0
...
After FCs:
Gas 50% @12% DTR</source>
        <translation type="vanished">FC 前 90 秒以上：
气体 50% @340 °F
...
&amp;#39;~E/10&amp;#39; will divide the E value by 10.
&amp;#39;~E+5&amp;#39; adds 5 to the the value of E.</source>
        <translation type="vanished">事件值的简单缩放是可能的。在字段之后使用单个数学运算符（&amp;#39;*&amp;#39;、&amp;#39;/&amp;#39;、&amp;#39;+&amp;#39; 或 &amp;#39;-&amp;#39;）名称“E”。例如：
&amp;#39;~E/10&amp;#39;将 E 值除以 10。
...
Note that if the event value  does not match any value in the Annotation definition a blank string will be returned.  In the example above an event value of 30 will return a blank string.  The easiest way to ensure these values match is to use Custom Buttons to for the Event.</source>
        <translation type="vanished">另一种注释风格允许将事件的数值替换为文本字符串，称为标称值。一个有用的例子是当一个事件被用来记录感官里程碑时。值 20 可能用于 &amp;#39;Fresh Cut Grass&amp;#39;香气，50 代表 &amp;#39;Hay&amp;#39;，80 代表 &amp;#39;Baking Bread&amp;#39;，100 代表 &amp;#39;A Point&amp;#39;。
...
When blank the load is assumed to be at a constant setting, which is the percent &amp;#39;Value 100%&amp;#39; multiplied by the rating.  A 10 kW load at &amp;#39;100% Value&amp;#39;= 60 would thus be 10 kW * 60% = 6 kW. Continuous loads are typically motors and blowers and the afterburner.</source>
        <translation type="vanished">特殊事件通常用于在烘焙配置文件中记录负载设置，例如燃烧器设置。在此处选择与负载设置对应的事件。
...
必须禁用键盘快捷键 (ENTER)</translation>
    ...
    <message>
        ...
        <translation>扫描单号需要先登录</tanslation>
    </message>
    <message>
...
注意：记录的数据将在未经确认的情况下被清除</translation>
    ...
    <message>
        ...
        <translation>TotalLINK 需要知道你烘焙的咖啡豆是什么。</translation>
    </message>
    <message>
...
Profile missing [CHARGE] or [DROP]</source>
    ...
    <message>
        ...
        <translation type="vanished">TotalLINK 需要知道你正在烘焙的咖啡豆</translation>
    </message>
    <message>
        <source>Artisan is free to use!

To keep it free and current please support us with your donation and subscribe to TotalLINK to suppress this dialog!</source>
        <translation type="vanished">Artisan 可以免费使用！

为了保持它的免费和最新，请通过您的捐赠支持我们并订阅 TotalLINK 以抑制此对话框！</translation>
    </message>
    <message>
...
Continue?</source>
    ...
    <message>
        <source>Updated data received from TotalLINK</source>
        <translation type="vanished">来自TotalLINK的更新数据已接收</translation>
    </message>
    <message>
        <source>Connected to TotalLINK as %1</source>
        <translation type="vanished">已连接到 TotalLINK，用户：%1</translation>
    </message>
    <message>
        <source>TotalLINK turned off</source>
        <translation type="vanished">TotalLINK关闭</translation>
    </message>
    <message>
        <source>Couldn't connect to TotalLINK</source>
        <translation type="vanished">无法连接到 TotalLINK</translation>
    </message>
    <message>
        <source>Disconnect TotalLINK?</source>
        <translation type="vanished">断开TotalLINK连接？</translation>
    </message>
    <message>
        <source>TotalLINK connection lost. Reconnecting automatically...</source>
        <translation type="vanished">TotalLINK 连接已断开。正在自动重新连接……</translation>
    </message>
    <message>
        <source>TotalLINK disconnected</source>
        <translation type="vanished">已断开TotalLINK连接</translation>
    </message>
    <message>
        <source>TotalLINK reconnected</source>
        <translation type="vanished">TotalLINK 重新连接</translation>
    </message>
</context><context>
...
未选中：拟合平滑样条曲线以保持曲线形状。</translation>
    ...
    <message>
        ...
        <source>Connect to TotalLINK service</source>
        <translation>连接到 TotalLINK 服务</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Syncing with TotalLINK</source>
        <translation>同步TotalLINK</translation>
    </message>
    <message>
        <location filename="../artisanlib/main.py" line="5452" />
        <location filename="../artisanlib/main.py" line="5418" />
        <source>Disconnect TotalLINK</source>
        <translation>断开TotalLINK</translation>
    </message>
    <message>
        <location filename="../artisanlib/main.py" line="5421" />
        <source>Upload to TotalLINK</source>
        <translation>上传到TotalLINK</translation>
    </message>
    <message>
        <location filename="../artisanlib/main.py" line="5455" />
        <source>Connect TotalLINK</source>
        <translation>连接TotalLINK</translation>
    </message>
    <message>
...
从而可以添加更多批次。</translation>
    ...
    <message>
        ...
        <translation type="vanished">连接到plus服务</translation>
    </message>
    <message>
...
必须减少4倍。</translation>
    ...
    <name>TotalLINK</name>
    <message>
        <location filename="../TotalLINK/controller.py" line="217" />
        <source>Keyring error: Ensure that gnome-keyring is installed.</source>
        <translation type="unfinished">密钥环错误: 确认gnome-keyring已安装.</translation>
    </message>
    <message>
        <location filename="../TotalLINK/controller.py" line="241" />
        <source>Login aborted</source>
        <translation type="unfinished">登入已终止</translation>
    </message>
    <message>
        <location filename="../TotalLINK/controller.py" line="250" />
        <source>authentified</source>
        <translation type="unfinished">已认证</translation>
    </message>
    <message>
        <location filename="../TotalLINK/controller.py" line="255" />
        <source>Connected to TotalLINK as %1</source>
        <translation type="unfinished">已连接到 TotalLINK，用户：%1</translation>
    </message>
    <message>
        <location filename="../TotalLINK/controller.py" line="376" />
        <location filename="../TotalLINK/controller.py" line="300" />
        <location filename="../TotalLINK/controller.py" line="277" />
        <source>TotalLINK turned off</source>
        <translation type="unfinished">TotalLINK关闭</translation>
    </message>
    <message>
        <location filename="../TotalLINK/controller.py" line="284" />
        <source>Authentication failed</source>
        <translation type="unfinished">认证失败</translation>
    </message>
    <message>
        <location filename="../TotalLINK/controller.py" line="309" />
        <source>Couldn't connect to TotalLINK</source>
        <translation type="unfinished">无法连接到 TotalLINK</translation>
    </message>
    <message>
        <location filename="../TotalLINK/controller.py" line="334" />
        <source>Disconnect TotalLINK?</source>
        <translation type="unfinished">断开TotalLINK连接？</translation>
    </message>
    <message>
        <location filename="../TotalLINK/controller.py" line="385" />
        <source>TotalLINK connection lost. Reconnecting automatically...</source>
        <translation type="unfinished">TotalLINK 连接已断开。正在自动重新连接……</translation>
    </message>
    <message>
        <location filename="../TotalLINK/controller.py" line="389" />
        <source>TotalLINK disconnected</source>
        <translation type="unfinished">已断开TotalLINK连接</translation>
    </message>
    <message>
        <location filename="../TotalLINK/controller.py" line="422" />
        <source>TotalLINK reconnected</source>
        <translation type="unfinished">TotalLINK 重新连接</translation>
    </message>
</context></TS>
